...
void MX_UART7_Init(void)
{
  ...
  /* USER CODE BEGIN UART7_Init 2 */
    ...
    HAL_UART_Receive_DMA(&huart7, USART7_RX_BUF, USART7_RX_BUF_LENGTH);
...
void MX_UART8_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart8, USART8_RX_BUF, USART8_RX_BUF_LENGTH);
...
void MX_UART9_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart9, USART9_RX_BUF, USART9_RX_BUF_LENGTH);
...
void MX_USART1_UART_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart1, USART1_RX_BUF, USART1_RX_BUF_LENGTH);
...
void MX_USART10_UART_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart10, USART10_BUF, USART10_RX_BUF_LENGTH);
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    */
    ...
    /* UART9 DMA Init */
    /* UART9_RX Init */
    hdma_uart9_rx.Instance = DMA2_Stream1;
    ...
    /* UART9_TX Init */
    hdma_uart9_tx.Instance = DMA2_Stream6;
  ...
  */
    ...
    */
    ...
    /* USART10_TX Init */
    hdma_usart10_tx.Instance = DMA2_Stream7;
...
{	
   if(huart->Instance == UART7)                                
    {	
        ...
        {
            // 清除 IDLE 标志位 (读状态寄存器ISR + 读数据寄存器RDR)
            __HAL_UART_CLEAR_IDLEFLAG(huart);
            
            // 调用回调函数
            USAR_UART7_IDLECallback(huart);
        }
    }
    ...
    {	
         if(__HAL_UART_GET_FLAG(huart, UART_FLAG_IDLE))
        {
            ...
            // 调用回调函数
            USAR_UART10_IDLECallback(huart);
        }
    }
}
...
void USAR_UART7_IDLECallback(UART_HandleTypeDef *huart)
{
    ...
    memset(USART7_RX_BUF,0,USART7_RX_BUF_LENGTH);

    HAL_UART_Receive_DMA(huart, (uint8_t *)USART7_RX_BUF, USART7_RX_BUF_LENGTH);
...
void USAR_UART8_IDLECallback(UART_HandleTypeDef *huart)
{
   ...
   HAL_UART_AbortReceive(&huart8);
    ...
    HAL_UART_Receive_DMA(huart, (uint8_t *)USART8_RX_BUF, USART8_RX_BUF_LENGTH);
