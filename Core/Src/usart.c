...
void MX_USART10_UART_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart10, usart10_rx_buf, RX_BUF_SIZE);
...
void USAR_UART10_IDLECallback(UART_HandleTypeDef *huart)
{
    ...
    SCB_InvalidateDCache_by_Addr((uint32_t*)usart10_rx_buf, RX_BUF_SIZE);
    
 
    Process_RC_Packet((char*)usart10_rx_buf, RX_BUF_SIZE);

    memset(usart10_rx_buf,0,RX_BUF_SIZE);

    HAL_UART_Receive_DMA(huart, (uint8_t *)usart10_rx_buf, RX_BUF_SIZE);
