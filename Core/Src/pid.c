...
void PID_Calc_All(void)
{
	...
	pid_3508[8] =  Clamp(PID_Calc(&pid_3508_loc[8], 0.7, 0.05, 0.50, PID_Calc(&pid_3508_speed[8], 0.55, 0, 0.20, motor[8].ExpectAngle, motor[8].accumulated_distance), motor[8].NowSpeed),   -2000.0f, 2000.0f);
	pid_3508[9] =  Clamp(PID_Calc(&pid_3508_loc[9], 0.7, 0.05, 0.50, PID_Calc(&pid_3508_speed[9], 0.55, 0, 0.20, motor[9].ExpectAngle, motor[9].accumulated_distance), motor[9].NowSpeed),   -2000.0f, 2000.0f);
