...
void PID_Calc_All(void)
{
	...
	pid_3508[10] = Clamp(PID_Calc(&pid_3508_loc[10], 3.40, 0.01, 1.2, PID_Calc(&pid_3508_speed[10], 0.55, 0.20, 0.0, motor[10].ExpectAngle, motor[10].accumulated_distance), motor[10].NowSpeed), -16384.0f, 16384.0f);
	pid_3508[11] = Clamp(PID_Calc(&pid_3508_loc[11], 3.40, 0.01, 3.50, PID_Calc(&pid_3508_speed[11], 0.55, 0, 0.20, motor[11].ExpectAngle, motor[11].accumulated_distance), motor[11].NowSpeed), -16384.0f, 16384.0f);
